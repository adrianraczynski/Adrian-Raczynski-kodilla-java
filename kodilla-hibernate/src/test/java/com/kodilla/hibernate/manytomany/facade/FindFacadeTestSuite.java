...
public class FindFacadeTestSuite {
    ...
    @Autowired
    FoundEmployeeFacade foundEmployeeFacade;
    ...
    public void testFindByAnyPartOfNameCompany() {
        ...
        //when
        List<Company> companies = foundEmployeeFacade.findNameOfCompanyByAnyPartOfName("soft");
        //then
    ...
    public void testFindByAnyPartOfNameEmployee() {
        ...
        //when
        List<Employee> employees = foundEmployeeFacade.findNameOfEmployeeByAnyPartOfName("owa");
        //then
